    ...
    <div class=\"col-md-3 col-sm-6 my-3 my-md-0\">
                <form action=\"buyerProduk.php\" method=\"post\">
                    <div class=\"card shadow\">
                        <div>
                            <img src=\"$product_image\" alt=\"Image1\" class=\"img-fluid card-img-top\" style = \"height : 13rem\">
                        </div>
                        <div class=\"card-body\">
...
function cartElement($product_image, $product_name, $apotek_name, $product_price, $id, $ket, $alamat, $kode, $pukul, $tanggal){
    ...
    <form action=\"buyerKeranjang.php?action=remove&id=$id\" method=\"post\" class=\"cart-items\">
