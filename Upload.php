...
<div class="col-lg-8">
    ...
    <div class="mb-3">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleNamaProduk">
      </div>
      <div class="mb-3">
        <label for="hargaSatuan" class="form-label">Harga Satuan</label>
        <input type="int" class="form-control" id="exampleHargaSatuan">
      </div>
      <div class="mb-3">
        <label for="stok" class="form-label">Stok</label>
        <input type="int" class="form-control" id="exampleStok">
      </div>
      <div class="mb-3">
