...
if(isset($_POST['update_profile'])){
   ...
   mysqli_query($conn, "UPDATE `pembeli_form` SET name = '$update_name', email = '$update_email' WHERE id = '$user_id'") or die('query failed');
   ...
   if(!empty($update_pass) || !empty($new_pass) || !empty($confirm_pass)){
      if($update_pass != $old_pass){
         ...
         mysqli_query($conn, "UPDATE `pembeli_form` SET password = '$confirm_pass' WHERE id = '$user_id'") or die('query failed');
   ...
   if(!empty($update_image)){
      if($update_image_size > 2000000){
         ...
         $image_update_query = mysqli_query($conn, "UPDATE `pembeli_form` SET image = '$update_image' WHERE id = '$user_id'") or die('query failed');
    ...
    <div class="wrapper">
        ...
        <div class="menu">
            <ul>
                ...
                <li><a href="buyerUpload.php">Upload</a></li>
...
<div class="update-profile bg-white">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <a href="buyerHome.php" class="delete-btn">Kembali</a>
   </form>
